...
You lift the pots and delete their marks.
...
Housekeeper will spot that when it removes the repeated point, you will be left with a singleton route with just a starting point and it will delete the route.
